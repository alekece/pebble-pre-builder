...
To set the menu icon of your app, name your image file `menu_icon.*`.
...
To do that, put the `fontinfo.json` file into `resources/fonts` folder and define the font size like :
